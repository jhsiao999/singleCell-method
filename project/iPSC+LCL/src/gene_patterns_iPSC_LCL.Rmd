...
#StructureObj(as.matrix(molecules_pluripotent_genes),nclus_vec,samp_metadata = samp_metadata, tol=0.001, batch_lab = NULL, path_rda="../../../project/rdas/topic_fit_ipsc_lcl_pluripotent_genes.rda",partition=c('TRUE'),path_struct = "../../figures/ipsc_lcl_pluripotent_genes_structure");
