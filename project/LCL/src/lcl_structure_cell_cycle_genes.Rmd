...
In this script, we perform Structure analysis on LCLs based on the cell cycle genes only. We first extract the single cells in LCL. 
...
#  obj <- StructureObj(lcl_single_cell_cycle_genes,nclus_vec[num],samp_metadata = samp_metadata, tol=0.005, batch_lab = batch_lab_single_cells, path=paste0("Structure/batch_uncorrected_cell_cycle_genes/clus_",nclus_vec[num]),partition=c('TRUE'));
#}

for(num in 1:length(nclus_vec))
{
  if(!dir.exists(paste0("Structure/batch_uncorrected_cell_cycle_genes/clus_",nclus_vec[num]))) dir.create(paste0("Structure/batch_uncorrected_cell_cycle_genes/clus_",nclus_vec[num]))
  omega <- as.matrix(read.table(paste0("Structure/batch_uncorrected_cell_cycle_genes/clus_",nclus_vec[num],"/omega_mat.txt")));
    obj <- StructureObj_omega(omega, samp_metadata = samp_metadata, batch_lab = batch_lab_single_cells, path=paste0("Structure/batch_uncorrected_cell_cycle_genes/clus_",nclus_vec[num]),partition = c("TRUE"));
}

```

<img src='Structure/batch_uncorrected_cell_cycle_genes/clus_2/struct_clus_2_cell_phase.png' style="width:304px;height:228px;">
<img src='Structure/batch_uncorrected_cell_cycle_genes/clus_3/struct_clus_3_cell_phase.png' style="width:304px;height:228px;">
<img src='Structure/batch_uncorrected_cell_cycle_genes/clus_4/struct_clus_4_cell_phase.png' style="width:304px;height:228px;">
<img src='Structure/batch_uncorrected_cell_cycle_genes/clus_5/struct_clus_5_cell_phase.png' style="width:304px;height:228px;">
...
#  obj <- StructureObj(batch_corrected_cell_cycle_genes,nclus_vec[num],samp_metadata = samp_metadata, tol=0.005, batch_lab = batch_lab_single_cells, path=paste0("Structure/batch_corrected_cell_cycle_genes/clus_",nclus_vec[num]),partition=c('TRUE'));
#}

for(num in 1:length(nclus_vec))
{
  if(!dir.exists(paste0("Structure/batch_corrected_cell_cycle_genes/clus_",nclus_vec[num]))) dir.create(paste0("Structure/batch_corrected_cell_cycle_genes/clus_",nclus_vec[num]))
  omega <- as.matrix(read.table(paste0("Structure/batch_corrected_cell_cycle_genes/clus_",nclus_vec[num],"/omega_mat.txt")));
    obj <- StructureObj_omega(omega, samp_metadata = samp_metadata, batch_lab = batch_lab_single_cells, path=paste0("Structure/batch_corrected_cell_cycle_genes/clus_",nclus_vec[num]),partition = c("TRUE"));
}
```

<img src='Structure/batch_corrected_cell_cycle_genes/clus_2/struct_clus_2_cell_phase.png' style="width:304px;height:228px;">
<img src='Structure/batch_corrected_cell_cycle_genes/clus_3/struct_clus_3_cell_phase.png' style="width:304px;height:228px;">
<img src='Structure/batch_corrected_cell_cycle_genes/clus_4/struct_clus_4_cell_phase.png' style="width:304px;height:228px;">
<img src='Structure/batch_corrected_cell_cycle_genes/clus_5/struct_clus_5_cell_phase.png' style="width:304px;height:228px;">
