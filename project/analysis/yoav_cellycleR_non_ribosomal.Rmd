...
filter1 <- grep("ribosomal", annotate_genes$name)
...
```{r echo=TRUE, eval=FALSE}
out <- cell_ordering_class(cycle_data_norm, celltime_levels = 100, num_iter=50, save_path="../rdas/cell_order_ipsc_non_ribosomal.rda")
