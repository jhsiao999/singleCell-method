...
n.out <- 200
omega_sim <- rbind(cbind(rep(1,n.out), rep(0,n.out)), cbind(rep(0,n.out), rep(1,n.out)), cbind(seq(0.6,0.4,length.out=n.out), 1- seq(0.6,0.4,length.out=n.out)));
K <- dim(omega_sim)[2];
...
We assume that we have FACS sorted the cells $1$ to $100$ and from $200$ to $300$.
