---
title: "Clustering of Po-Yuan data based on cell cycle genes"
author: "Kushal K Dey"
date: "September 3, 2015"
output: html_document
---

In this script, we perform an admixture model clustering + tSNE model +PCA model approach on the single cell data collected by Yoav's lab, using only the cell cycle gene expression. 
...
We now fit an admixture model on the reduced data comprising of only the cell cycle genes.
...
We now implement t-SNE on the single cells based on the data on the cell cycle genes to see how the single cells cluster
