...
StructureObj(batch_corrected_pooled ,nclus_vec,samp_metadata = samp_metadata, tol=0.1, batch_lab = NULL, path_rda="../../project/rdas/topic_fit_ipsc_lcl_batchcorrect.rda",partition=c('TRUE'),path_struct = "../figures/ipsc_lcl_structure_batchcorrect");
ipsc_lcl_topics_batchcorrect <- get(load("../../project/rdas/topic_fit_ipsc_lcl_batchcorrect.rda"));
}
...
StructureObj(molecules_pooled_cell_cycle_genes ,nclus_vec,samp_metadata = samp_metadata, tol=0.1, batch_lab = NULL, path_rda="../../project/rdas/topic_fit_ipsc_lcl_cellcycle.rda",partition=c('TRUE'),path_struct = "../figures/ipsc_lcl_structure_cellcycle");
ipsc_lcl_topics_cellcycle <- get(load("../../project/rdas/topic_fit_ipsc_lcl_cellcycle.rda"));
}
...
StructureObj(batch_corrected_cell_cycle_genes ,nclus_vec,samp_metadata = samp_metadata, tol=0.1, batch_lab = NULL, path_rda="../../project/rdas/topic_fit_ipsc_lcl_cellcycle_batchcorrect.rda",partition=c('TRUE'),path_struct = "../figures/ipsc_lcl_structure_cellcycle_batchcorrect");
ipsc_lcl_topics_cellcycle_batchcorrect <- get(load("../../project/rdas/topic_fit_ipsc_lcl_cellcycle_batchcorrect.rda"));
}
