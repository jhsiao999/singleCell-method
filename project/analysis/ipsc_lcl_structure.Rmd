...
#StructureObj(molecules_single_pooled,nclus_vec,samp_metadata = samp_metadata, tol=0.001, batch_lab = NULL, path_rda="../../../project/rdas/topic_fit_ipsc_lcl.rda",partition=c('TRUE'),path_struct = "../../figures/ipsc_lcl_structure");
...
#StructureObj(batch_corrected_pooled,nclus_vec,samp_metadata = samp_metadata, tol=0.001, batch_lab = NULL, path_rda="../../../project/rdas/topic_fit_ipsc_lcl_batchcorrect.rda",partition=rep('TRUE',dim(samp_metadata)[2]),path_struct = "../../figures/ipsc_lcl_structure_batchcorrect");
...
#StructureObj(molecules_pooled_cell_cycle_genes,nclus_vec,samp_metadata = samp_metadata, tol=0.001, batch_lab = NULL, path_rda="../../../project/rdas/topic_fit_ipsc_lcl_cellcycle.rda",partition=rep('TRUE',dim(samp_metadata)[2]),path_struct = "../../figures/ipsc_lcl_structure_cellcycle");
