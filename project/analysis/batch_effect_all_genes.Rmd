---
title: "Batch effect modeling on all genes"
author: "Kushal K Dey"
...
heatmap.2(cor_batch,scale="none",trace="none",labRow=cell_phase_vector,labCol=cell_phase_vector,breaks=c(seq(-1,0,0.07),seq(0,0.5,0.05),seq(0.6,1,0.1)),col=col,distfun=function(x) dist(x,method="euclidean"),hclustfun=function(x) hclust(x,method="average"));
...
{
Topic_clus <- topics(data, K=K, tol=0.001);
...
sapply(2:5, function(k) structure_cell_cycle_genes(exp_batch_removed_cpm_data,k,cell_phase_vector))
